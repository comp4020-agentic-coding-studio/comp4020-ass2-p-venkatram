...
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP1163",
  title: "Experience Subjective Consciousness",
  session: "Semester 1",
  year: 2027,
  level: 1,
  ...
  endDate: "2027-05-28",
  description:
    "A practicum, not a survey: twelve weeks spent closing the gap between " +
    "describing an experience and having it, one deliberately induced " +
    "sensation at a time, in pursuit of the hard problem of consciousness.",
  tags: ["phenomenology", "consciousness studies", "embodied practice"],
